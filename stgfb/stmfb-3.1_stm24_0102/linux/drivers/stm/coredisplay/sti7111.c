...
#if (defined(UFS912) || defined(SPARK) || defined(HS7110) || defined(WHITEBOX) || defined(HS7810A) || defined(VITAMIN_HD5000)) && defined(__TDT__)
#define HAS_DSUB 0
...
#if (defined(UFS912) || defined(SPARK) || defined(HS7810A) || defined(HS7110) || defined(WHITEBOX) || defined(VITAMIN_HD5000)) && defined(__TDT__)
    .dvo_output_id            = -1,
#else
